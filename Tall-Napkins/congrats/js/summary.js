...
function changeBlack() {
	document.getElementById('logo').src='congrats/img/logo-congrats.png';
	document.getElementById('list_v').style.color = 'black';
	document.getElementById('list_v2').style.color = 'black';
}
function changegenericBirthdayBlack() {
	document.getElementById('logo').src='congrats/img/logo-genericBirthday.png';
	document.getElementById('list_v').style.color = 'black';
	document.getElementById('list_v2').style.color = 'black';
}

function changeWhite() {
	document.getElementById('logo').src='congrats/img/logo-white-congrats.png';
	document.getElementById('list_v').style.color = 'white';
	document.getElementById('list_v2').style.color = 'white';
}

function changeSilver() {
	document.getElementById('logo').src='congrats/img/logo-silver-congrats.png';
	document.getElementById('list_v').style.color = '#cccccc';
	document.getElementById('list_v2').style.color = '#cccccc';
}

function changeRed() {
	document.getElementById('logo').src='congrats/img/logo-red-congrats.png';
	document.getElementById('list_v').style.color = '#d40404';
	document.getElementById('list_v2').style.color = '#d40404';
}

function changeGold() {
	document.getElementById('logo').src='congrats/img/logo-gold-congrats.png';
